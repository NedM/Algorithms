...
namespace Algorithms.Types
{
    ...
    public class Edge<T> : EdgeBase<T> where T : struct, IComparable, IEquatable<T>
    {
        ...
        public Edge(Vertex<T> from, Vertex<T> to, double cost = 0)
        {
            this.Tail = from;
            this.Head = to;
            base.Weight = cost;
    ...
    public struct Edge_Lite : IEquatable<Edge_Lite>, IComparable<Edge_Lite>
    {
        private int tail;
        private int head;
        private double weight;

        public Edge_Lite(int tail, int head, double weight = 0)
        {
            this.tail = tail;
            this.head = head;
            this.weight = weight;
        ...
        public Edge_Lite DeepCopy()
        {
            Edge_Lite copy = new Edge_Lite(this.Tail, this.Head, this.Weight);
            return copy;
        }

        public bool Equals(Edge_Lite other)
        {
        ...
        public int CompareTo(Edge_Lite other)
        {
        ...
        public override string ToString()
        {
            return string.Format("({0}, {1}, {2})", this.Tail, this.Head, this.Weight);
        }
    }
